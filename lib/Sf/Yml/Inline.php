...
/**
 * ZendR_Sf_Yml_Inline implements a YAML parser/dumper for the YAML inline syntax.
 *
 * @package    symfony
 * @subpackage yaml
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: ZendR_Sf_Yml_Inline.class.php 16177 2009-03-11 08:32:48Z fabien $
 */
class ZendR_Sf_Yml_Inline
{
    ...
    {
        if ('1.1' === ZendR_Sf_Yml::getSpecVersion()) {
