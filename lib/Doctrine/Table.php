...
class ZendR_Doctrine_Table extends Doctrine_Table
{
    ...
    public function getSqlFiltrar(array $request, $orderby = null, $titles = array())
    {
        ...
        if (isset($request['campo'])) {
            if (trim($request['campo']) != '') {
                $class = $this->_identifyClass($class, array($request['campo']), self::PROCESS_FILTER);
            }
        }
    ...
    {
         /**$query = "CREATE DEFINER = 'root'@'localhost' FUNCTION IF NOT EXISTS remove_accent(str VARCHAR(5000)) RETURNS VARCHAR(5000)
            RETURN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(str,'a','a'),'á','a'),'á','a'),'à','a'),'à','a'),'ã','a'),'ã','a'),'â','a'),'â','a'),'ä','a'),'ä','a'),'é','e'),'é','e'),'è','e'),'è','e'),'ê','e'),'ê','e'),'ë','e'),'ë','e'),'í','i'),'í','i'),'ì','i'),'ì','i'),'î','i'),'î','i'),'ï','i'),'ï','i'),'ó','o'),'ó','o'),'ò','o'),'ò','o'),'õ','o'),'õ','o'),'ô','o'),'ô','o'),'ö','o'),'ö','o'),'ú','u'),'ú','u'),'ù','u'),'ù','u'),'û','u'),'û','u'),'ü','u'),'ü','u'),'ç','c'),'ç','c'),'ñ','n'),'ñ','n');";
        ...
        return $this->getConnection()->quote(str_replace($a, $b, $string));
    }
    
    public function prepareStringSearch($string)
    {
        /**
         *$query = "CREATE DEFINER=`root`@`localhost` FUNCTION `prepare_string_search`(`str` VARCHAR(5000))
         ...
         * 
         */
        return $this->getConnection()->quote(ZendR_String::parseString($string)->prepareStringSearch()->__toString());
    }
